      ...
      <v-sheet height="600">
        ...
        >
          <template v-slot:day="day">
            <v-sheet v-if="showDateLabel(day)" :color="color" class="white--text pa-1">
              <span>{{showDateLabel(day)}}</span>
            </v-sheet>
          </template>
        </v-calendar>
      </v-sheet>
...
export default {
  data: () => ({
    dayLabelItems: {
      '2019-03-03': 'birthday',
      '2019-03-07': 'establish wiki-x team',
      '2019-03-15': 'deadline of annual ideas',
      '2019-03-17': 'launch 2019 annual projects',
      '2019-03-30': '1st project progress report',
      '2019-04-30': '1st project and members audit',
      '2019-06-30': '2nd project and members audit'
    },
    dark: false,
    startMenu: false,
    start: '2019-03-03',
  ...
  methods: {
    ...
    showDateLabel (day) {
      for (var i in this.dayLabelItems) {
        if (day.date === i) {
          return this.dayLabelItems[i]
        }
      }
    }
  }
