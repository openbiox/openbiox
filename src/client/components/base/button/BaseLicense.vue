<template>
  <div class="text-xs-center license-box">
    <v-dialog v-model="dialog" width="1200">
      ...
      <v-card>
        ...
        <v-card-text class="license-box-text">
